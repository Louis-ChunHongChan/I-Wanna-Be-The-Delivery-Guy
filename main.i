...
void initialize() {
    ...
    (*(volatile unsigned short *)0x400000A) = ((0) << 2) | ((31) << 8) | (3 << 14);
...
void goToStart() {
    ...
    (*(volatile unsigned short *)0x4000000) = 3 | (1 << 9) | (1 << 12);
    DMANow(3, titlePal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, titleTiles, &((charblock *)0x6000000)[0], 17408 / 2);
    DMANow(3, titleMap, &((screenblock *)0x6000000)[31], 2048 / 2);
...
void initArrow() {
    arrow.height = 16;
    arrow.width = 16;
    arrow.row = 160 / 2 + arrow.width * 2 + 9;
    arrow.col = 240 / 2 - arrow.width * 7 - 5;
}

void drawArrow() {
    shadowOAM[14].attr0 = arrow.row | (0 << 14);
    shadowOAM[14].attr1 = arrow.col | (1 << 14);
    shadowOAM[14].attr2 = ((0)*32 + (0)) | ((0) << 12);
}
...
void start() {
    ...
    if ((!(~(oldButtons) & ((1 << 7))) && (~buttons & ((1 << 7)))) && t_select == 0) {
        t_select++;
        arrow.row += 20;
    }

    if ((!(~(oldButtons) & ((1 << 6))) && (~buttons & ((1 << 6)))) && t_select == 1) {
        t_select--;
        arrow.row -= 20;
    }


    if ((!(~(oldButtons) & ((1 << 3))) && (~buttons & ((1 << 3)))) && t_select == 0) {
        initGame();
        goToGame();
    }
    else if ((!(~(oldButtons) & ((1 << 3))) && (~buttons & ((1 << 3)))) && t_select == 1) {
        goToInstruction();
    }
}
...
void goToInstruction() {
    ...
    DMANow(3, instructionTiles, &((charblock *)0x6000000)[0], 17728 / 2);
    DMANow(3, instructionMap, &((screenblock *)0x6000000)[31], 2048 / 2);
    (*(volatile unsigned short *)0x4000000) = 0 | (1 << 9) | (1 << 12);
    waitForVBlank();
...
void goToGame() {
    ...
    DMANow(3, levelMap, &((screenblock *)0x6000000)[28], 6144 / 2);
    (*(volatile unsigned short *)0x4000008) = ((1) << 2) | ((30) << 8) | (2 << 14);
...
void goToPause() {
    ...
    DMANow(3, pauseTiles, &((charblock *)0x6000000)[0], 15776 / 2);
...
void goToLose() {
    ...
    DMANow(3, loseTiles, &((charblock *)0x6000000)[0], 18944 / 2);
